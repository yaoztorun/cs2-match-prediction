...
from player_roster_feature_engine import ROSTER_DIRECTIONAL_FEATURES, ROSTER_SYMMETRIC_FEATURES, ROSTER_PERFORMANCE_DIFFS
...
EVAL_SCRIPT = ROOT / "scripts" / "evaluate_series_feature_sets_v4.py"
...
FROZEN_PATHS = [
    ...
    "scripts/player_roster_feature_engine.py",
    "scripts/player_roster_stream_common.py",
    "scripts/build_series_features_v4_roster.py",
    ...
    "scripts/preprocessing_common_v3_form.py",
    "scripts/evaluate_series_feature_sets_v2.py",
    "scripts/evaluate_series_feature_sets_v3.py",
    ...
    "config/series_features_v4_roster.yaml",
    ...
    "reports/phase5c_player_roster_feature_engineering.md",
    "reports/phase5c_player_roster_feature_quality.md",
