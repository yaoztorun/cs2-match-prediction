...
PRE_PHASE8D_ARTIFACTS = [
    ...
    "tests/test_phase8c_tournament_engine.py",
    "scripts/validate_phase8c.py",
    "scripts/run_phase8c_synthetic_demo.py",
    "reports/phase8c_tournament_engine.md",
    ...
    "scripts/preprocessing_random_forest_v1.py",
...
PHASE8D_SOURCE_FILES = [
    "scripts/pre_veto_series_predictor.py", "scripts/build_phase8d_protocol.py",
    "scripts/generate_cologne_pre_event_probability_matrix.py", "scripts/cologne_pre_event_simulation.py",
    "scripts/run_phase8d_pipeline.py", "scripts/phase8d_figures.py", "scripts/phase8d_common.py",
]
...
CANONICAL_FILES = {
    "protocol": ROOT / "config" / "phase8d_cologne_pre_event_simulation_protocol.yaml",
...
def main():
    ...
    figures_source = (ROOT / "scripts" / "phase8d_figures.py").read_text(encoding="utf-8")
