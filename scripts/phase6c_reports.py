...
from modern_map_feature_engine import MODERN_MAP_DIRECTIONAL_FEATURES, MODERN_MAP_SYMMETRIC_FEATURES
...
def main():
    ...
    md.append("Nothing here says any feature is useful. Coverage, spread and completeness are properties of "
              ...
              "`scripts/evaluate_map_feature_sets_v3.py` (Stage B) - never here.\n")

    (REPORTS / "phase6c_modern_map_feature_quality.md").write_text("\n".join(md), encoding="utf-8")
