...
engine (scripts/team_form_engine.py). The engine itself knows nothing about
"Kaggle", "development" or "Cologne" - every such concept lives here,
mirroring scripts/map_stream_common.py's role for the Phase 5A map engine.

Reuses (imports, never modifies) scripts/build_series_features_v1.py's own
...
from build_series_features_v1 import build_stream_rows
