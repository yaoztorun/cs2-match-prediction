...
def main():
    ...
    builder_files = ["scripts/build_deployment_history_manifest.py", "scripts/build_deployment_series_state.py",
                      "scripts/build_deployment_map_state.py", "scripts/build_deployment_form_state.py",
                      "scripts/build_deployment_roster_state.py", "scripts/build_deployment_modern_map_state.py"]
    ...
    phase8e_protocol = yaml.safe_load((ROOT / "config" / "phase8e_cologne_simulation_vs_reality_protocol.yaml")
                                       .read_bytes())
    ...
    report_path = ROOT / "reports" / "phase9a_post_cologne_deployment_state.md"
