...
CONFIG_V1_PATH = ROOT / "config" / "series_features_v1.yaml"
...
EVAL_SCRIPT = ROOT / "scripts" / "evaluate_series_feature_sets_v2.py"
...
BASELINE_HASHES = {
    ...
    "config/series_features_v1.yaml": None,
    "config/series_features_v2_map_pool.yaml": None,
    "config/map_features_v1.yaml": None,
    ...
    "models/random_forest_v2.joblib": None,
    "models/random_forest_v2.json": None,
    "models/xgboost_v2.json": None,
    "models/xgboost_v2_metadata.json": None,
    "models/logistic_regression_scratch_v2.npz": None,
    "models/logistic_regression_scratch_v2.json": None,
...
def main():
    ...
    if not AUDIT_PATH.exists():
        ...
        import preprocessing_common as pc1
        import preprocessing_random_forest_v1 as rf1
        import preprocessing_xgboost_v1 as xgb1
    ...
    # repo's own test suite already documents (tests/test_random_forest_v1.py)
