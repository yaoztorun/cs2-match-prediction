...
this script trivially satisfies the "only scripts/evaluate_phase7_test_once.py
may select split=='test'" rule (brief section 30) - it never even loads that
file as a dataframe, just hashes its bytes.

Must be run AFTER scripts/evaluate_phase7_test_once.py,
scripts/phase7_test_reports.py, scripts/phase7_test_bootstrap.py and
scripts/phase7_test_visualizations.py are written (so their source hashes can
...
EVAL_CODE = {
    "evaluate_phase7_test_once": ROOT / "scripts" / "evaluate_phase7_test_once.py",
    "phase7_test_reports": ROOT / "scripts" / "phase7_test_reports.py",
    "phase7_test_bootstrap": ROOT / "scripts" / "phase7_test_bootstrap.py",
    "phase7_test_visualizations": ROOT / "scripts" / "phase7_test_visualizations.py",
    "phase7_evaluation_protocol_config": ROOT / "config" / "phase7_test_evaluation_protocol.yaml",
}
