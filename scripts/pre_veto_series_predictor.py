...
MODEL_PATH = ROOT / "models" / "random_forest_v2.joblib"
...
SERIES_FEATURES_YAML_PATH = ROOT / "config" / "series_features_v1.yaml"
FEATURE_ENGINE_PATH = ROOT / "scripts" / "feature_engine.py"
PREPROCESSING_MODULE_PATH = ROOT / "scripts" / "preprocessing_random_forest_v1.py"
PREDICTOR_PATH = ROOT / "scripts" / "pre_veto_series_predictor.py"
TOURNAMENT_YAML_PATH = ROOT / "config" / "tournaments" / "iem_cologne_major_2026_pre_event.yaml"
TOURNAMENT_ENGINE_PATH = ROOT / "scripts" / "tournament_engine.py"
