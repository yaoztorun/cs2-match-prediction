...
import pre_veto_series_predictor as pvp  # reuse sha256_file, not redefine it
...
IMMUTABLE_PRE_EVENT_HASH_INPUTS = {
    ...
    "phase8c_tournament_engine": ROOT / "scripts" / "tournament_engine.py",
    "rf_v2_model": ROOT / "models" / "random_forest_v2.joblib",
