...
READ CONTRACT (brief correction #3, enforced by scripts/validate_phase7.py):
...
from map_modeling_common import compute_metrics, series_macro_metrics
...
def write_report(metrics_df, baseline_df, sm_df, per_map_df, bo_df, tier_df, cov_df, cal_df, dev_df,
    ...
    (REPORTS / "phase7_internal_test_results.md").write_text("\n".join(md), encoding="utf-8")
