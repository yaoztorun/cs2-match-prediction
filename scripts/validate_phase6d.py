...
from preprocessing_common_map_v2 import transformed_feature_names, UNKNOWN_MAP_CATEGORY, UNKNOWN_TIER_CATEGORY
...
PHASE6C_SCRIPTS = [
    "scripts/modern_map_feature_engine.py", "scripts/modern_map_stream_common.py",
    "scripts/build_map_features_v3_modern_map.py", "scripts/build_pre_cologne_modern_map_state_v1.py",
    "scripts/rich_modern_map_feature_composer.py", "scripts/preprocessing_common_map_v3.py",
    "scripts/preprocessing_random_forest_map_v3.py", "scripts/preprocessing_xgboost_map_v3.py",
    "scripts/evaluate_map_feature_sets_v3.py", "scripts/validate_phase6c.py",
]
PHASE1_6C_ARTIFACTS = [
    "data/features/map_features_v2_rich.parquet", "data/features/map_features_v3_modern_map.parquet",
    "config/map_features_v2_rich.yaml", "config/map_features_v3_modern_map.yaml",
    ...
    "models/map_random_forest_v1.joblib", "models/map_xgboost_v1.json",
    "reports/phase6b_known_map_model_results.md", "reports/phase6c_modern_map_cv_results.md",
...
def main():
    ...
    model_path = MODELS / "map_xgboost_v3_final.json"
    meta_path = MODELS / "map_xgboost_v3_final_metadata.json"
