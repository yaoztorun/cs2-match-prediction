...
from map_stream_common import load_map_stream, cologne_cutoff, canonical_eligibility_map
...
MAP_CFG = ROOT / "config" / "map_features_v1.yaml"
SER_CFG = ROOT / "config" / "series_features_v2_map_pool.yaml"
SRC_DIR = ROOT / "src"
...
BASELINE_HASHES = {
    ...
    "config/series_features_v1.yaml": "31f71bea039fc9b64fd8abc29eaac2aca4a407700b1dadfec833ac576c08481f",
    ...
    "scripts/feature_engine.py": "9650fc15d36a212520af1810b14cc40c80ce298c54113090dc7db42a6cbd7f29",
    "scripts/preprocessing_common.py": "272e090b53847d30120979713d13118b28eebe37e1d03371444a207c676ed101",
    ...
    "models/logistic_regression_scratch_v2.npz": "afaee2b0ef62775af8b55a580d60b8987ee0bff63a5d67ba275d12ae2e4cf0ee",
    "models/logistic_regression_scratch_v2.json": "febf663c8f0f50950f592fe46e4687e28d0c392db7c747a1a4e5a1c9e44ca7f7",
...
def check_artifacts_exist():
    ...
    for p in [MAP_FEATURES, SERIES_V2, SNAP_PARQUET, SNAP_JSON, MAP_CFG, SER_CFG,
              ROOT / "scripts" / "map_feature_engine.py",
              ROOT / "scripts" / "map_stream_common.py",
              ROOT / "tests" / "test_map_feature_engine.py",
              REPORTS / "phase5a_map_feature_engineering.md",
              REPORTS / "phase5a_map_feature_quality.md",
...
def check_recomputation(mapf, ser):
    ...
    for _, row in sample_series.iterrows():
        ...
        store = MapStateStore()
        from map_feature_engine import apply_map_result
