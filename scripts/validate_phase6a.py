...
BUILD_SCRIPT = ROOT / "scripts" / "build_map_features_v2_rich.py"
SPLIT_SCRIPT = ROOT / "scripts" / "build_map_split_v1.py"
CV_SCRIPT = ROOT / "scripts" / "build_map_cv_folds_v1.py"
...
FROZEN_PATHS = [
    "scripts/feature_engine.py", "scripts/build_series_features_v1.py",
    "scripts/map_feature_engine.py", "scripts/map_stream_common.py",
    "scripts/build_series_features_v2_map_pool.py", "scripts/build_map_features_v1.py",
    "scripts/team_form_engine.py", "scripts/team_form_stream_common.py",
    "scripts/build_series_features_v3_form.py",
    "scripts/player_roster_feature_engine.py", "scripts/player_roster_stream_common.py",
    "scripts/build_series_features_v4_roster.py", "scripts/build_pre_cologne_player_roster_state_v1.py",
    ...
    "config/series_features_v1.yaml", "config/series_features_v2_map_pool.yaml",
    "config/series_features_v3_form.yaml", "config/series_features_v4_roster.yaml",
