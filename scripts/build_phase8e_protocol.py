...
ARTIFACT_PATHS = {
    ...
    "report": "reports/phase8e_cologne_simulation_vs_reality.md",
}
    ...
    return {
        ...
        "immutable_pre_event_record": {
            "note": "These 14 items (15 files - Phase 8D.1's provenance bullet is 2 files) are the "
                    ...
                    "Hashes below are the baseline; scripts/phase8e_common.py re-verifies them.",
...
def main():
    ...
    out_path = ROOT / "config" / "phase8e_cologne_simulation_vs_reality_protocol.yaml"
