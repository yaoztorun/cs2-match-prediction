...
from preprocessing_common_map_v2 import load_map_v2_roles, build_augmented_training_raw as build_aug_v2
import preprocessing_random_forest_map_v2 as prep_rf_v2
import preprocessing_xgboost_map_v2 as prep_xgb_v2
from preprocessing_common_map_v3 import load_map_v3_roles
from preprocessing_common_map_v2 import build_augmented_training_raw as build_aug_v3   # roles-driven, reusable
import preprocessing_random_forest_map_v3 as prep_rf_v3
import preprocessing_xgboost_map_v3 as prep_xgb_v3

TABLES_DIR = REPORTS / "tables"
FIGURES_DIR = REPORTS / "figures"
V3_PATH = ROOT / "data" / "features" / "map_features_v3_modern_map.parquet"
V3_CONFIG_PATH = ROOT / "config" / "map_features_v3_modern_map.yaml"
V2_CONFIG_PATH = ROOT / "config" / "map_features_v2_rich.yaml"
...
def grouped_permutation_importance(model, X, y, feature_names, groups, n_repeats=10, random_state=42):
    ...
    scripts/evaluate_series_feature_sets_v3.py's implementation."""
...
def write_report(rf_sel, xgb_sel, pair_df, mean_delta_df, pooled_df, additional_correct, cov_df,
    ...
    (REPORTS / "phase6c_modern_map_cv_results.md").write_text("\n".join(md), encoding="utf-8")
