...
BUILD_SCRIPT = ROOT / "scripts" / "build_map_features_v3_modern_map.py"
...
FROZEN_PATHS = [
    "scripts/feature_engine.py", "scripts/map_feature_engine.py", "scripts/map_stream_common.py",
    "scripts/team_form_engine.py", "scripts/player_roster_feature_engine.py",
    "scripts/player_roster_stream_common.py", "scripts/rich_map_feature_composer.py",
    "scripts/build_map_features_v2_rich.py", "scripts/build_map_split_v1.py",
    "scripts/build_map_cv_folds_v1.py", "scripts/validate_phase6a.py", "scripts/validate_phase6b.py",
    "scripts/preprocessing_common_map_v2.py", "scripts/preprocessing_random_forest_map_v2.py",
    "scripts/preprocessing_xgboost_map_v2.py", "scripts/map_modeling_common.py",
    "scripts/models/map_random_forest_tuning_v1.py", "scripts/models/map_xgboost_tuning_v1.py",
    "scripts/map_selected_oof_v1.py", "scripts/train_map_models_v1.py",
