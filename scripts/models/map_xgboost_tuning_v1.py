...
from preprocessing_common_map_v2 import (                            # noqa: E402
...
def write_report(agg, winner_id, stage, params_by_id, wagg, best_iterations, final_n_estimators, cache):
    ...
    md.append(f"Generated by `scripts/models/map_xgboost_tuning_v1.py`. **{len(agg)} candidates** "
    ...
    (REPORTS / "phase6b_map_xgboost_tuning.md").write_text("\n".join(md), encoding="utf-8")
