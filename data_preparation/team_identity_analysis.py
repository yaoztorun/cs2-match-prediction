...
def main():
    ...
    md.append("Generated by `data_preparation/team_identity_analysis.py`. Investigates whether normalized `team_name` is "
    ...
    (REPORTS / "phases" / "team_identity_analysis.md").write_text("\n".join(md), encoding="utf-8")
