"""
Tests for scripts/modern_map_feature_engine.py (Phase 6C). Synthetic fixtures
...
def test_weighted_map_wr_uses_beta_2_2_smoothing():
    ...
    from modern_map_feature_engine import SelectedMapHistoryEntry
...
def test_later_map_sees_earlier_maps_state():
    ...
    - exactly as scripts/build_map_features_v3_modern_map.py does - before
...
def test_map_specialization_is_a_difference_never_a_ratio():
    ...
    from map_feature_engine import compute_team_map_features
