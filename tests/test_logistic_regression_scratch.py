...
(scripts/models/logistic_regression_scratch.py), independent of the CS2
...
MODEL_SOURCE_PATH = Path(__file__).resolve().parents[1] / "scripts" / "models" / "logistic_regression_scratch.py"
