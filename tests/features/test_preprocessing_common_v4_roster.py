"""
Tests for feature_engineering/preprocessing/preprocessing_common_v4_roster.py (Phase 5C.1). Confirms
...
from feature_engineering.preprocessing.preprocessing_common_v4_roster import load_v4_roles, V4_BINARY_SYMMETRIC_FEATURES
from feature_engineering.preprocessing.preprocessing_common_v2_map_pool import mirror_raw_rows, transformed_feature_names
...
from feature_engineering.roster.player_roster_feature_engine import ROSTER_PERFORMANCE_DIFFS
