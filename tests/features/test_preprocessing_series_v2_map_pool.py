"""
Tests for feature_engineering/preprocessing/preprocessing_common_v2_map_pool.py,
feature_engineering/preprocessing/preprocessing_random_forest_v2_map_pool.py and
feature_engineering/preprocessing/preprocessing_xgboost_v2_map_pool.py - the config-driven V2 map-pool
mirroring/preprocessing layer written for Phase 5B.1. Synthetic fixtures only,
same style as tests/features/test_preprocessing_random_forest.py.
"""
...
from feature_engineering.preprocessing.preprocessing_common_v2_map_pool import (
...
from feature_engineering.preprocessing.preprocessing_random_forest_v2_map_pool import (
    fit_preprocessing as rf_fit_preprocessing, transform as rf_transform,
)
from feature_engineering.preprocessing.preprocessing_xgboost_v2_map_pool import (
