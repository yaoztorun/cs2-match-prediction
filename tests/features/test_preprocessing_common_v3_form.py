"""
Tests for feature_engineering/preprocessing/preprocessing_common_v3_form.py (Phase 5B.3). Confirms the
...
from feature_engineering.preprocessing.preprocessing_common_v3_form import load_v3_roles, V3_BINARY_SYMMETRIC_FEATURES
