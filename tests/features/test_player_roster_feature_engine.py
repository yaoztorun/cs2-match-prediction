"""
Tests for feature_engineering/roster/player_roster_feature_engine.py (Phase 5C). Synthetic
fixtures only - no dependency on real data (real-data checks live in
validation/validate_phase5c.py), matching this repo's convention for feature
engines (tests/features/test_map_feature_engine.py, tests/features/test_team_form_engine.py).
"""
