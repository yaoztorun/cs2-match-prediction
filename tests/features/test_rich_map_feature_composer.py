"""
Tests for feature_engineering/maps/rich_map_feature_composer.py (Phase 6A). Synthetic
...
from feature_engineering.series.feature_engine import StateStore, HistoryEntry, TeamState, ELO_INITIAL
from feature_engineering.maps.map_feature_engine import MapStateStore, apply_map_result
from feature_engineering.form.team_form_engine import TeamFormStateStore, apply_form_result
