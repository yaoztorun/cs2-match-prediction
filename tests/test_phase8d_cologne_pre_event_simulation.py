...
simulation are generated once by scripts/run_phase8d_pipeline.py, and a
...
import run_phase8d_pipeline as pipe
...
def test_tournament_engine_still_never_reads_participants():
    source = (te.ROOT / "scripts" / "tournament_engine.py").read_text(encoding="utf-8")
