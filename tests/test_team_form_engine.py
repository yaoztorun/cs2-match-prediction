"""
Tests for scripts/team_form_engine.py (Phase 5B.2). Synthetic-fixture only -
no dependency on real data (real-data checks live in
scripts/validate_phase5b2.py), matching this repo's established convention
for feature-engine test suites (tests/test_map_feature_engine.py).
"""
...
def test_recency_weight_formula_exact_values():
    from team_form_engine import _recency_weight
...
#        exhaustive check in scripts/build_series_features_v3_form.py) ---
