...
from training.logistic_regression.logistic_regression_scratch import compute_cost_reg, compute_gradient_reg
...
def test_tuning_uses_the_frozen_scratch_primitives():
    ...
    assert "from training.logistic_regression.logistic_regression_scratch import" in src
