...
from training.random_forest.random_forest_v1 import build_model, save_model, load_model, RF_CONFIG
...
from feature_engineering.preprocessing.preprocessing_random_forest_v1 import build_augmented_training_raw
...
def test_augmentation_doubles_only_the_given_train_slice():
    ...
    # verified by inspection of training/random_forest/train_random_forest_v1.py).
