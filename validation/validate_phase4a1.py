...
from training.logistic_regression.logistic_regression_scratch import predict_proba
from feature_engineering.preprocessing.preprocessing_logistic_v1 import transform
from training.logistic_regression.logistic_regression_tuning_v2 import (
...
V2_NPZ = ROOT / "models" / "series" / "logistic_regression_scratch_v2.npz"
V2_META = ROOT / "models" / "series" / "logistic_regression_scratch_v2.json"
TUNING_SOURCE = ROOT / "training" / "logistic_regression" / "logistic_regression_tuning_v2.py"
TRAIN_SOURCE = ROOT / "training" / "logistic_regression" / "train_logistic_regression_v2.py"
SCRATCH_CORE = ROOT / "training" / "logistic_regression" / "logistic_regression_scratch.py"
SRC_DIR = ROOT / "src"
...
def main():
    ...
    check("refit script uses the frozen scratch primitives",
          "from training.logistic_regression.logistic_regression_scratch import" in train_src)
