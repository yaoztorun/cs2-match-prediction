...
from feature_engineering.preprocessing.preprocessing_xgboost_v1 import transform
...
V2_MODEL = ROOT / "models" / "series" / "xgboost_v2.json"
V2_META = ROOT / "models" / "series" / "xgboost_v2_metadata.json"
TRAIN_SOURCE = ROOT / "training" / "xgboost" / "train_xgboost_v2.py"
TUNING_SOURCE = ROOT / "training" / "xgboost" / "xgboost_tuning_v2.py"
SRC_DIR = ROOT / "src"
...
BASELINE_HASHES = {
    ...
    "reports/phases/phase4c_xgboost_v1.md": "0200f07e174523cabe86d8a3ba66561a666f0d01cf7a8104b91d6cb3cd4f2642",
    "reports/phases/xgboost_symmetry_v1.md": "cecaeb8144b345b6ff7f51273077b2514d99a50ebced66a3ff46e8c0d2454fcf",
}
...
def main():
    ...
    from training.xgboost.xgboost_tuning_v2 import split_inner_early_stop
