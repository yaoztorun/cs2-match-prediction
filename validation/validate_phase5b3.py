...
EVAL_SCRIPT = ROOT / "evaluation" / "validation" / "evaluate_series_feature_sets_v3.py"
...
FROZEN_PATHS = [
    ...
    "feature_engineering/state/build_pre_cologne_form_state_v1.py",
    "feature_engineering/preprocessing/preprocessing_common_v2_map_pool.py",
    "feature_engineering/preprocessing/preprocessing_random_forest_v2_map_pool.py",
    "feature_engineering/preprocessing/preprocessing_xgboost_v2_map_pool.py",
    ...
    "reports/phases/phase5b2_team_form_feature_engineering.md",
    "reports/phases/phase5b2_team_form_feature_quality.md",
