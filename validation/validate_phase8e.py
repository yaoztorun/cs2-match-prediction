...
def main():
    ...
    protocol_path = ROOT / "config" / "evaluation" / "phase8e_cologne_simulation_vs_reality_protocol.yaml"
    ...
    pred_module_path = ROOT / "evaluation" / "cologne_2026" / "build_phase8e_predictions.py"
    ...
    fig_module_path = ROOT / "evaluation" / "cologne_2026" / "phase8e_figures.py"
    ...
    report_path = ROOT / "reports" / "phases" / "phase8e_cologne_simulation_vs_reality.md"
