...
def main():
    print("\n=== 1. context registry ===")
    registry = yaml.safe_load((ROOT / "config" / "application" / "application_inference_contexts_v1.yaml").read_bytes())
    ...
    ai_path = ROOT / "application" / "inference" / "application_inference.py"
    ...
    report_path = ROOT / "reports" / "phases" / "phase9b_application_inference_core.md"
