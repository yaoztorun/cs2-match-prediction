...
REPORT_PATH = ROOT / "reports" / "phases" / "phase8b_cologne_tournament_definition.md"
IDENTITY_POLICY_PATH = ROOT / "data" / "interim" / "team_identity_policy.csv"
PHASE8A_REPORT_PATH = ROOT / "reports" / "phases" / "phase8a_application_prediction_contracts.md"
...
PRE_PHASE8B_ARTIFACTS = [
    ...
    "reports/phases/phase8a_application_prediction_contracts.md",
]
