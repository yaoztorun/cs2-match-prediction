...
engine (feature_engineering/maps/modern_map_feature_engine.py). Mirrors map_stream_common.py's
...
no new ELO replay is needed, and feature_engineering/maps/build_map_features_v3_modern_map.py
...
from feature_engineering.series.feature_engine import ELO_INITIAL
import feature_engineering.maps.map_stream_common as map_stream_common
import feature_engineering.roster.player_roster_stream_common as player_roster_stream_common
