...
Mirrors the design of feature_engineering/series/feature_engine.py (Phase 3) and
feature_engineering/maps/map_feature_engine.py (Phase 5A) and deliberately REUSES Phase 3's
...
merely asserted) in feature_engineering/form/build_series_features_v3_form.py before any V3
artifact is written, and re-verified in validation/validate_phase5b2.py.
...
from feature_engineering.series.feature_engine import ELO_INITIAL, ELO_K, elo_expected, elo_update, REQUIRED_STREAM_COLUMNS
...
def normalized_series_margin(score_for, score_against):
    ...
    normalization convention feature_engineering/maps/map_feature_engine.py uses for map
