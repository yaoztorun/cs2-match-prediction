...
HISTORICAL_REPLAY_IMMUTABLE_RECORD = {
    ...
    "rf_v2_model": MODELS / "series" / "random_forest_v2.joblib",
    ...
    # Phase 8E
    "phase8e_protocol": ROOT / "config" / "evaluation" / "phase8e_cologne_simulation_vs_reality_protocol.yaml",
    ...
    "known_map_xgb_v3_model": MODELS / "map" / "map_xgboost_v3_final.json",
    "known_map_xgb_v3_metadata": MODELS / "map" / "map_xgboost_v3_final_metadata.json",
...
DEPLOYMENT_BUILD_CODE_INPUTS = {
    "feature_engine": ROOT / "feature_engineering" / "series" / "feature_engine.py",
    "build_series_features_v1": ROOT / "feature_engineering" / "series" / "build_series_features_v1.py",
    "map_feature_engine": ROOT / "feature_engineering" / "maps" / "map_feature_engine.py",
    "map_stream_common": ROOT / "feature_engineering" / "maps" / "map_stream_common.py",
    "team_form_engine": ROOT / "feature_engineering" / "form" / "team_form_engine.py",
    "team_form_stream_common": ROOT / "feature_engineering" / "form" / "team_form_stream_common.py",
    "player_roster_feature_engine": ROOT / "feature_engineering" / "roster" / "player_roster_feature_engine.py",
    "player_roster_stream_common": ROOT / "feature_engineering" / "roster" / "player_roster_stream_common.py",
    "modern_map_feature_engine": ROOT / "feature_engineering" / "maps" / "modern_map_feature_engine.py",
    "modern_map_stream_common": ROOT / "feature_engineering" / "maps" / "modern_map_stream_common.py",
    "phase9a_common": ROOT / "feature_engineering" / "state" / "phase9a_common.py",
    "build_deployment_history_manifest": ROOT / "feature_engineering" / "state" / "build_deployment_history_manifest.py",
    "build_deployment_series_state": ROOT / "feature_engineering" / "state" / "build_deployment_series_state.py",
    "build_deployment_map_state": ROOT / "feature_engineering" / "state" / "build_deployment_map_state.py",
    "build_deployment_form_state": ROOT / "feature_engineering" / "state" / "build_deployment_form_state.py",
    "build_deployment_roster_state": ROOT / "feature_engineering" / "state" / "build_deployment_roster_state.py",
    "build_deployment_modern_map_state": ROOT / "feature_engineering" / "state" / "build_deployment_modern_map_state.py",
}
