...
semantics as feature_engineering/preprocessing/preprocessing_random_forest_map_v2.py - median
...
lists (feature_engineering/preprocessing/preprocessing_common_map_v3.py) via the SAME generic
