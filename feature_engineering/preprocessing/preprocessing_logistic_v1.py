...
algorithm-independent and lives in feature_engineering/preprocessing/preprocessing_common.py, shared
with feature_engineering/preprocessing/preprocessing_random_forest_v1.py - re-exported here so
existing imports (`from preprocessing_logistic_v1 import mirror_raw_rows`
etc., used by training/logistic_regression/train_logistic_regression_v1.py,
validation/validate_phase4a.py, and tests/features/test_preprocessing_logistic.py) keep
...
tests/features/test_preprocessing_logistic.py's future-inference symmetry test).
...
from feature_engineering.preprocessing.preprocessing_common import (  # noqa: F401 - re-exported for backward compatibility
