...
RULESETS_REGISTRY_PATH = CONFIG / "application" / "application_tournament_rulesets_v1.yaml"
...
def verify_ruleset_matches_engine_rules(ruleset_id=DEFAULT_RULESET_ID):
    ...
    checks = {
        ...
        "tournament_engine_py_sha256": (hashlib.sha256((ROOT / "tournament" / "engine" / "tournament_engine.py").read_bytes()).hexdigest()
...
def verify_historical_cologne_contract():
    ...
    try:
        ...
        d_checks = {
            ...
            "tournament_engine": _sha256_file(ROOT / "tournament" / "engine" / "tournament_engine.py") == d_hashes["tournament_engine"],
