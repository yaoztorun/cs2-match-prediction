...
RF_PIPELINE = {
    "rf_model": MODELS / "series" / "random_forest_v2.joblib",
    ...
    "series_feature_schema_yaml": CONFIG / "features" / "series_features_v1.yaml",
    "feature_engine": ROOT / "feature_engineering" / "series" / "feature_engine.py",
    "preprocessing_random_forest_v1": ROOT / "feature_engineering" / "preprocessing" / "preprocessing_random_forest_v1.py",
    "predictor_adapter": ROOT / "tournament" / "simulation" / "pre_veto_series_predictor.py",
}

XGB_PIPELINE = {
    "xgb_model": MODELS / "map" / "map_xgboost_v3_final.json",
    "xgb_metadata": MODELS / "map" / "map_xgboost_v3_final_metadata.json",
    ...
    "map_v3_feature_schema_yaml": CONFIG / "features" / "map_features_v3_modern_map.yaml",
    "rich_modern_map_feature_composer": ROOT / "feature_engineering" / "maps" / "rich_modern_map_feature_composer.py",
    "rich_map_feature_composer": ROOT / "feature_engineering" / "maps" / "rich_map_feature_composer.py",
    "preprocessing_xgboost_map_v3": ROOT / "feature_engineering" / "preprocessing" / "preprocessing_xgboost_map_v3.py",
    "preprocessing_common_map_v2": ROOT / "feature_engineering" / "preprocessing" / "preprocessing_common_map_v2.py",
    "preprocessing_common_map_v3": ROOT / "feature_engineering" / "preprocessing" / "preprocessing_common_map_v3.py",
    "feature_engine": ROOT / "feature_engineering" / "series" / "feature_engine.py",
...
def main():
    ...
    out_path = CONFIG / "application" / "application_inference_contexts_v1.yaml"
