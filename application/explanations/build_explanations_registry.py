...
import feature_engineering.state.phase9a_common as p9a  # reuses sha256_file, nothing else
...
def build():
    ...
    registry = {
        ...
        "hashes": {
            ...
            "feature_groups_config": sha256_file(CONFIG / "application" / "application_explanation_feature_groups_v1.yaml"),
    ...
    out_path = CONFIG / "application" / "application_explanations_v1.yaml"
