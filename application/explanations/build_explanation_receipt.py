...
def build():
    ...
    receipt = {
        ...
        "hashes": {
            ...
            "explanation_registry": sha256_file(CONFIG / "application" / "application_explanations_v1.yaml"),
            "feature_groups_registry": sha256_file(CONFIG / "application" / "application_explanation_feature_groups_v1.yaml"),
            "fixture_manifest": sha256_file(CONFIG / "application" / "application_explanation_fixtures_v1.yaml"),
