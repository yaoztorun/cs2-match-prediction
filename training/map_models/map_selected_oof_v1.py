...
from feature_engineering.maps.map_feature_families import feature_family_map, FAMILY_LABELS
...
def write_summary(rf_sel, xgb_sel, weight_rf, ens_stage, weight_table, oof_metrics, winner, ranking,
    ...
    (REPORTS / "phases" / "phase6b_known_map_tuning_summary.md").write_text("\n".join(md), encoding="utf-8")
